...
def _draw_mark(mark_type, options={}, axes_options={}, **kwargs):
    ...
    for name, traitlet in mark_type.class_traits(scaled=_check_scaled).items():
        ...
        # been passed.
            ...
            value = kwargs.get(name, traitlet.default_value)
            value = traitlet.validate(None, value)
            dtype = value.dtype if hasattr(value, 'dtype') else dtype(type(value))
            print 2, name, dtype
